...
<jsp:useBean id="emp" class="test.jdbc.Emp"></jsp:useBean>
<jsp:useBean id="service" class="test.jdbc.EmpService"></jsp:useBean>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<jsp:setProperty property="regdate" name="emp" value="new java.util.Date()"/>
