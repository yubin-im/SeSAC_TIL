...
public class Board {
	private int num	;	private String name	;	private String email	;	private String pwd	;
	private String subject	;	private String content	;	private Date regdate	; //kdt책에 보면 SimpleDateFormat을 이용하여 날짜를 이쁘게...
	private int hit	;	private int parent	;	private int sort	;	private int tab	;	private String original;
